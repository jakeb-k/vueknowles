...
<template>
    <div class="h-screen w-full bg-smoke block">

        <div class="pt-32 ml-[5%] bg-smoke">
        ...
        <div class="flex flex-row w-11/12 mx-auto py-28 relative">
             ...
             <button @click="viewSwitch()" class="size-16 absolute bottom-10 left-[53.5%]">
